      ...
      <div className="w-full max-w-sm text-center text-white relative">
        ...
        <div className="relative z-10">
          ...
          <button
            ...
            className="bg-gradient-to-r cursor-pointer from-orange-500 to-orange-400 hover:bg-gradient-to-br hover:from-orange-600 to-orange-700 text-white font-semibold py-2 rounded-full w-full mt-2"
          >
            REGISTRARSE
          </button>
