...
export default function AddProductosForm() {
  ...
  const [tipo, setTipo] = useState("comidas"); // comida o helado
  const [categoria, setCategoria] = useState("");

  const categoriasComida = [
    "pizzas",
    "empanadas",
    "pasta tartas y tortillas",
    "sandwichs",
    "papas fritas",
    "milanesas y milapizzas",
    "ensaladas",
    "pollo al espiedo",
    "hamburguesas, hamburpizza",
    "picadas",
    "promos",
  ];
  ...
  return (
    <div className="bg-neutral-900 text-white p-6 rounded-lg max-w-md mx-auto mt-8 shadow-xl">
      ...
      >
        ...
        {(tipo === "comida" ? categoriasComida : categoriasHelado).map(
          (cat) => (
