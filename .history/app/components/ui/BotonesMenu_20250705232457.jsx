    ...
    <div className="flex flex-col gap-6 items-center">
      <div className="grid grid-cols-2 gap-6">
        {botonesFiltrados.map((btn, i) => (
          <div
            key={i}
            className="bg-white/30  text-black rounded-lg p-6 w-36 h-28 flex flex-col items-center justify-center shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer"
