...
export default function AddProductosForm() {
  ...
  const [setProductos] = useState<any[]>([]);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#852123] relative">
      ...
      <div className="relative z-10 bg-neutral-900/70 text-white p-6 rounded-xl max-w-md mx-auto shadow-2xl w-full">
        <BackArrow label="" />
        ...
        <CategoriaSelector
          categoria={categoria}
          setCategoria={setCategoria}
          categorias={tipo === "comidas" ? categoriasComida : categoriasHelado}
        />
