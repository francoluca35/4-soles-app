...
export default function RegisterPage() {
  ...
  const [rol, setRol] = useState('admin'); // default
    ...
    <div className="min-h-screen bg-[#852123] flex items-center justify-center px-4">
      <div className="w-full max-w-sm text-center text-white relative">
        ...
        <div className="relative z-10">
          ...
          <select
            className="bg-transparent border-none border border-orange-400 text-white w-full mb-4 p-2 focus:outline-none"
            onChange={(e) => setRol(e.target.value)}
            value={rol}
          >
            <option className='text-black' value="admin">Admin</option>
            <option className='text-black' value="repartidor">Repartidor</option>
            <option className='text-black' value="caja">Caja</option>
          </select>

          <button
            onClick={handleRegister}
            className="bg-gradient-to-r cursor-pointer from-orange-500 to-orange-400 hover:bg-gradient-to-br hover:from-orange-400 hover:to-orange-600 text-white font-semibold py-2 rounded-full w-full mt-2"
          >
            REGISTRARSE
          </button>
