...
export default function AddProductosForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#852123] relative">
      <BackArrow label="Volver" /> {/* Fondo del logo centrado */}
      ...
      <div className="relative z-10 bg-neutral-900/60 text-white p-6 rounded-lg max-w-md mx-auto shadow-xl w-full">
        ...
        >
          <option className="text-black" value="comidas">
            Comida
          </option>
          <option className="text-black" value="helados">
            Helado
          </option>
        </select>
        ...
        <input
          type="file"
          accept="image/*"
          className="w-full p-2 mb-4 bg-orange-700/40 text-white rounded border border-gray-400"
